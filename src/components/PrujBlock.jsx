export const PrujBlock = () => {
  ...
  return (
    <section
      className={`pruj_block ${isLinkActive ? "active-animation" : ""}`}
      title="Заміна пружинного блока"
      id="pruj"
    >
            ...
            <div className="pruj_block_all">
              <div className="pruj_block_box">
                ...
                <div className="pruj_block_img">
                  <img
                    src="./img/general/block.webp"
                    className="pruj_block_img_box"
              ...
              <div className="pruj_block_content">
                <div className="pruj_block_content_col">
                  ...
                  <ul className="pruj_block_content_ul">
                    <li className="pruj_block_content_li pruj_block_content_price">
                      4100 грн
                    </li>
                    <li className="pruj_block_content_li">
                      <span>-</span> Заміна Пружинного Блока
                    </li>
                    <li className="pruj_block_content_li">
                      <span>-</span> Гарантія 12 місяців
                    </li>
                    <li className="pruj_block_content_li">
                      <span>-</span> Безкоштовна Доставка
                    </li>
                  </ul>
                </div>
                <div className="pruj_block_content_col">
                  ...
                  <ul className="pruj_block_content_ul">
                    ...
                    <li className="pruj_block_content_li">
                      <span>-</span> Заміна Поролона
                    </li>
                    <li className="pruj_block_content_li">
                      <span>-</span> Заміна Войлока
                    </li>
                  </ul>
                </div>
                <div className="pruj_block_content_col">
              ...
              <a
                ...
                className="btn_pruj_block"
              >
                Замовити Заміну Пружинного Блока
              </a>
            </div>
          </div>
        </div>
