...
import { getAllArticleById, refreshToken } from "../api";
  ...
  return (
    <section className="listPage">
      <Helmet>
        ...
        <meta name="description" content={`${product.seoDescribe}`} />
        <meta name="keywords" content={`${product.seoTitle}`} />
        <link rel="canonical" href={`https://mevaro.kiev.ua/article/${id}`} />
      </Helmet>
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="article_box_page">
              ...
              <div className="article_icon_finger_box">
                <span className="finger_icon">
                  <FaHandPointDown />
                </span>
              </div>
              <div
                dangerouslySetInnerHTML={createMarkup(product.describe)}
                className="article_decribe"
              />
